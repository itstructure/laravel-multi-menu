...
class MultiMenuWidget {
     ...
     * @return bool
     */
    public static function checkNewParentId(Model $mainModel, int $newParentId, string $primaryKeyName = 'id', string $parentKeyName = 'parentId'): bool
    {
     ...
     * @param string $parentKeyName
     */
    public static function afterDeleteMainModel(Model $mainModel, string $primaryKeyName = 'id', string $parentKeyName = 'parentId'): void
    {
    ...
    private function renderItems(array $items, int $level = 0): string
    {
        ...
        foreach ($items as $item) {
            ...
            $itemsContent .= view('multiMenuWidget::'.$this->levelAttributeValue($this->itemTemplate, $level), array_merge([
                    'data' => $item['data']
